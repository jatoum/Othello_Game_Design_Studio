"""
This script is called by the plugin-wrapper, myPlugin.js, which passes down the
...
plugin = myPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
