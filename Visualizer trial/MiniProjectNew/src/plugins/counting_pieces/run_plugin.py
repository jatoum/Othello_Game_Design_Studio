"""
This script is called by the plugin-wrapper, counting_pieces.js, which passes down the
...
from counting_pieces import counting_pieces
...
plugin = counting_pieces(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
